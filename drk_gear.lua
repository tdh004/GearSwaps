function user_setup()
	...
	sets.midcast.MaxHaste = {
		head="HeathenFallen's burgeonet",body="Heathen's Cuirass",hands="Heathen's gauntlets",legs="Ares' Flanchard +1",waist="Dynamic belt +1"
	}
	sets.midcast.sTP = {
	...
	-- Why do I need this?
	sets.midcast['Endark'] = {   
		head="Ignominy burgeonet",body="Demon's harness",hands="Fall. Fin. Gaunt.",legs="Heathen's Flanchard",neck="Deceiver's Torque",ear1="Dark earring",back="Merciful cape",waist="Casso sash"
		}
	...
	sets.midcast['Tractor'] = sets.midcast.MaxHaste
